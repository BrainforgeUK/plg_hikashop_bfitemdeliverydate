			...
			<tr>
				<td>
					...
					<table width="100%" style="font-family: Verdana, Arial, Helvetica, sans-serif;font-size:12px;">
                        ...
                        // Start Added BRAINFORGE for bf_item_delivery_date / bf_order_delivery_date plugins
                        if ($namekey == 'item_delivery_date' && class_exists('plgHikashopBFItemDeliveryDate')) continue;
                        if ($namekey == 'order_delivery_date' && class_exists('plgHikashopBFOrderDeliveryDate')) continue;
                        // End Added BRAINFORGE for bf_item_delivery_date / bf_order_delivery_date plugins
